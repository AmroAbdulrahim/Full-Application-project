...
let uesrData = JSON.parse(user)
// console.log(uesrData.name)
console.log(uesrData)

// document.getElementById("user-email").innerHTML = uesrData.email
// document.getElementById("user-name").innerHTML = uesrData.name
// document.getElementById("user-username").innerHTML = uesrData.username
// document.getElementById("comment-count").innerHTML = uesrData.comments_count
// document.getElementById("posts-count").innerHTML = uesrData.posts_count
// document.getElementById("header-image").src = uesrData.profile_image
        ...
        for (post of posts){
            ...
            <div class="card my-5" style="cursor: pointer;">
                <div class="card-header" style="background-color: #eee; cursor: default;">
                    <img src="${post.author.profile_image}" onclick="userProfile()" style="width: 40px; height: 40px; border-radius: 50% 50%; cursor: pointer"" alt="">
                    <b onclick="userProfile()" style="cursor: pointer">@${post.author.username}</b>
                    ${editButton}
                    ${deleteButton}
                </div>
